           ...
           if type == "document":
              await bot.send_document(
	            update.message.chat.id,
                    ...
                    caption=caption, 
                    progress=progress_for_pyrogram,
                    progress_args=( "⚠️ **Please wait...**\nProcessing file to upload as doc...",  ms, c_time)) 
           elif type == "video": 
               await bot.send_video(
	            ...
	            duration=duration,
	            progress=progress_for_pyrogram,
	            progress_args=( "⚠️ **Please wait...**\nProcessing file to upload as video...",  ms, c_time)) 
           elif type == "audio": 
               await bot.send_audio(
	            ...
	            duration=duration,
	            progress=progress_for_pyrogram,
	            progress_args=( "⚠️ **Please wait...**\nProcessing file to upload as audio...",  ms, c_time)) 
        except Exception as e: 
