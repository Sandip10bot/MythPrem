  ...
  #  if user_id in ADMINS: return # ignore admins
    if PM_SEARCH == True:
        ...
        await message.reply_text(
            text=f"<b>ʜᴇʏ {user},\n\n You can't get files from here.",   
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 Request Here", url=f"https://t.me/")]])
        )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, 
            [
                InlineKeyboardButton(f'✴️ Quality', callback_data=f"qualities#{key}"),
                InlineKeyboardButton("✳️ Episode", callback_data=f"episodes#{key}"),
                InlineKeyboardButton("✳️ Season",  callback_data=f"seasons#{key}")
            ]
        )
        btn.insert(0, [
            InlineKeyboardButton("Select 👇", callback_data="select"),
            InlineKeyboardButton("🗣️ Language", callback_data=f"languages#{key}")
        ])
        btn.insert(0, [
...
async def episodes_cb_handler(client: Client, query: CallbackQuery):
    ...
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Bᴀᴄᴋ ᴛᴏ Fɪʟᴇs ↭", callback_data=f"fe#homepage#{key}")])
...
async def filter_episodes_cb_handler(client: Client, query: CallbackQuery):
    ...
    if settings["button"]:
        ...
        btn.insert(0, 
            [
                InlineKeyboardButton(f'✴️ Quality', callback_data=f"qualities#{key}"),
                InlineKeyboardButton("✳️ Episodes", callback_data=f"episodes#{key}"),
                InlineKeyboardButton("✳️ Seasons",  callback_data=f"seasons#{key}")
            ]
        )
        btn.insert(0, [
...
async def languages_cb_handler(client: Client, query: CallbackQuery):
    ...
    req = query.from_user.id
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Bᴀᴄᴋ ᴛᴏ Fɪʟᴇs ​↭", callback_data=f"fl#homepage#{key}")])
...
async def seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    req = query.from_user.id
    offset = 0
    btn.append([InlineKeyboardButton(text="↭ Bᴀᴄᴋ ᴛᴏ Fɪʟᴇs ​↭", callback_data=f"next_{req}_{key}_{offset}")])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "close_data":
        ...
        btn = [[            
            InlineKeyboardButton("✅ Sᴇɴᴅ Yᴏᴜʀ Pᴀʏᴍᴇɴᴛ Rᴇᴄᴇɪᴘᴛ Hᴇʀᴇ ✅", user_id=admin)
        ]
            for admin in ADMINS
        ]
        btn.append(
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            await query.answer("Not For You My Dear", show_alert=True)
        ...
        if query.from_user.id in ADMINS:
            ...
            await query.answer("Yᴏᴜ dᴏɴ'ᴛ hᴀᴠᴇ Sᴜғғɪᴄɪᴀɴᴛ Rɪɢᴛs tᴏ dᴏ tʜɪs !", show_alert=True)
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
             ...
             InlineKeyboardButton('Rename File', callback_data='r_txt'),   
             ...
             InlineKeyboardButton('Earn 🤑', callback_data='shortlink_info')
         ], [
      ...
      await query.message.edit_text(
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='1993')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='1997')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='1998')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2000')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2002')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2008')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2009')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2011')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        await client.edit_message_media(
            query.message.chat.id, 
            query.message.id, 
            InputMediaPhoto("https://graph.org/file/c8792929b6c9c51f8d53d.jpg")
        )
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.DKDM,
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2013')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2015')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2017')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2018')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2019')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
        ...
        #    InlineKeyboardButton('❗❗ Disclaimer ❗❗', callback_data='disclaimer')
        #], [
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ⇋', callback_data='2023')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text="■ □ □"
